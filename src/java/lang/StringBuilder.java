...
public final class StringBuilder extends AbstractStringBuilder implements java.io.Serializable, CharSequence {
	...
	/**
	 * Constructs a string builder with no characters in it and an initial capacity
	 * specified by the {@code capacity} argument.
	 *
	 * @param capacity the initial capacity.
	 * @throws NegativeArraySizeException if the {@code capacity} argument is less
	 *                                    than {@code 0}.
	 */
	 ...
	 * specified {@code CharSequence}. The initial capacity of the string builder is
	 * {@code 16} plus the length of the {@code CharSequence} argument.
	 *
	 ...
	 * argument. If {@code sb} is {@code null}, then the four characters
	 ...
	 * to the character at index <i>k-n</i> in the argument {@code sb}.
	 *
	...
	/**
	 * Save the state of the {@code StringBuilder} instance to a stream (that is,
	 * serialize it).
	 *
	 * @serialData the number of characters currently stored in the string builder
	 *             ({@code int}), followed by the characters in the string builder
	 *             ({@code char[]}). The length of the {@code char} array may be
	 *             greater than the number of characters currently stored in the
	 *             string builder, in which case extra characters are ignored.
	 */
