...
abstract class AbstractStringBuilder implements Appendable, CharSequence {
	 ...
	 * </ul>
	 * If the {@code minimumCapacity} argument is nonpositive, this method takes no
	 * action and simply returns. Note that subsequent operations on this object can
	 * reduce the actual capacity below that requested here.
	 *
	...
	/**
	 * For positive values of {@code minimumCapacity}, this method behaves like
	 * {@code ensureCapacity}, however it is never synchronized. If
	 * {@code minimumCapacity} is non positive due to numeric overflow, this method
	 * throws {@code OutOfMemoryError}.
	 */
	...
	/**
	 * The maximum size of array to allocate (unless necessary). Some VMs reserve
	...
	/**
	 * Returns a capacity at least as large as the given minimum capacity. Returns
	 * the current capacity increased by the same amount + 2 if that suffices. Will
	 * not return a capacity greater than {@code MAX_ARRAY_SIZE} unless the given
	 * minimum capacity is greater than that.
	 *
	 * @param minCapacity the desired minimum capacity
	 * @throws OutOfMemoryError if minCapacity is less than zero or greater than
	 *                          Integer.MAX_VALUE
	 */
	 ...
	 * index <i>k</i> in the new character sequence is the same as the character at
	 * index <i>k</i> in the old sequence if <i>k</i> is less than the length of the
	 ...
	 * sequence, and the {@code char} value at the following index is in the
	 ...
	 * sequence. The text range begins at the specified {@code beginIndex} and
	 ...
	 * surrogates within this sequence count as one code point each.
	 *
	 ...
	 *                                      then the length of this sequence, or if
	 *                                      {@code codePointOffset} is positive and
	 *                                      the subsequence starting with
	 *                                      {@code index} has fewer than
	 *                                      {@code codePointOffset} code points, or
	 *                                      if {@code codePointOffset} is negative
	 *                                      and the subsequence before {@code index}
	 ...
	 * {@code dst}. The first character to be copied is at index {@code srcBegin};
	 * the last character to be copied is at index {@code srcEnd-1}. The total
	 * number of characters to be copied is {@code srcEnd-srcBegin}. The characters
	 * are copied into the subarray of {@code dst} starting at index
	 ...
	 *                                   <li>the {@code srcBegin} argument is
	 *                                   greater than the {@code srcEnd} argument.
	...
	/**
	 * The character at the specified index is set to {@code ch}. This sequence is
	 * altered to represent a new character sequence that is identical to the old
	 * character sequence, except that it contains the character {@code ch} at
	 * position {@code index}.
	 * <p>
	 * The index argument must be greater than or equal to {@code 0}, and less than
	 * the length of this sequence.
	 ...
	 * by the method {@link String#valueOf(Object)}, and the characters of that
	 * string were then {@link #append(String) appended} to this character sequence.
	 *
	 ...
	 * of the {@code append} method. Then the character at index <i>k</i> in the new
	 * character sequence is equal to the character at index <i>k</i> in the old
	 * character sequence, if <i>k</i> is less than <i>n</i>; otherwise, it is equal
	 * to the character at index <i>k-n</i> in the argument {@code str}.
	 *
	 * @param str a string.
	 * @return a reference to this object.
	 */
	 ...
	 * <p>
	 * Characters of the argument {@code s}, starting at index {@code start}, are
	 * appended, in order, to the contents of this sequence up to the (exclusive)
	 * index {@code end}. The length of this sequence is increased by the value of
	 * {@code end - start}.
	 * <p>
	 * Let <i>n</i> be the length of this character sequence just prior to execution
	 * of the {@code append} method. Then the character at index <i>k</i> in this
	 * character sequence becomes equal to the character at index <i>k</i> in this
	 * sequence, if <i>k</i> is less than <i>n</i>; otherwise, it is equal to the
	 * character at index <i>k+start-n</i> in the argument {@code s}.
	 * <p>
	 * If {@code s} is {@code null}, then this method appends characters as if the s
	...
	/**
	 * Appends the string representation of the {@code char} array argument to this
	 * sequence.
	 * <p>
	 ...
	 * {@code offset}, are appended, in order, to the contents of this sequence. The
	 * length of this sequence increases by the value of {@code len}.
	 * <p>
	 * The overall effect is exactly as if the arguments were converted to a string
	 * by the method {@link String#valueOf(char[],int,int)}, and the characters of
	 ...
	 * <p>
	 * The overall effect is exactly as if the argument were converted to a string
	 * by the method {@link String#valueOf(int)}, and the characters of that string
	 * were then {@link #append(String) appended} to this character sequence.
	 *
	 * @param i an {@code int}.
	 * @return a reference to this object.
	 ...
	 * <p>
	 * The overall effect is exactly as if the argument were converted to a string
	 * by the method {@link String#valueOf(long)}, and the characters of that string
	 * were then {@link #append(String) appended} to this character sequence.
	 *
	 * @param l a {@code long}.
	 * @return a reference to this object.
	 ...
	 * <p>
	 * The overall effect is exactly as if the argument were converted to a string
	 * by the method {@link String#valueOf(float)}, and the characters of that
	 * string were then {@link #append(String) appended} to this character sequence.
	 *
	 ...
	 * <p>
	 * The overall effect is exactly as if the argument were converted to a string
	 * by the method {@link String#valueOf(double)}, and the characters of that
	 * string were then {@link #append(String) appended} to this character sequence.
	 *
	 ...
	 * at the specified {@code start} and extends to the character at index
	 * {@code end - 1} or to the end of the sequence if no such character exists. If
	...
	/**
	 * Appends the string representation of the {@code codePoint} argument to this
	 * sequence.
	 *
	 * <p>
	 * The argument is appended to the contents of this sequence. The length of this
	 * sequence increases by {@link Character#charCount(int)
	 ...
	 * character in that array were then {@link #append(char[]) appended} to this
	 * character sequence.
	 *
	 * @param codePoint a Unicode code point
	 * @return a reference to this object.
	 * @exception IllegalArgumentException if the specified {@code codePoint} isn't
	 ...
	 * supplementary characters is required, determine the number of {@code char}s
	 * to remove by calling
	 ...
	 * {@code start} and extends to the character at index {@code end - 1} or to the
	 * end of the sequence if no such character exists. First the characters in the
	 * substring are removed and then the specified {@code String} is inserted at
	 * {@code start}. (This sequence will be lengthened to accommodate the specified
	 * String if necessary.)
	 *
	 * @param start The beginning index, inclusive.
	 * @param end   The ending index, exclusive.
	 ...
	 * @param end   The ending index, exclusive.
	 * @return The new string.
	 * @throws StringIndexOutOfBoundsException if {@code start} or {@code end} are
	 ...
	 * {@code offset} and extends {@code len} {@code char}s. The characters of the
	 * subarray are inserted into this sequence at the position indicated by
	 ...
	 *                                         greater than {@code length()}, or
	 *                                         {@code offset} or {@code len} are
	 *                                         negative, or {@code (offset+len)} is
	...
	/**
	 * Inserts the string representation of the {@code Object} argument into this
	 * character sequence.
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 * string by the method {@link String#valueOf(Object)}, and the characters of
	 ...
	 * sequence at the position indicated by {@code offset}. The length of this
	 ...
	 * <p>
	 * The characters of the {@code CharSequence} argument are inserted, in order,
	 ...
	 * this object's {@link #insert(int,CharSequence,int,int) insert}(dstOffset, s,
	 * 0, s.length()) method.
	 *
	 * <p>
	 ...
	 * destination offset, moving up any characters originally above that position.
	 ...
	 * than {@code dstOffset}
	 * <li>the character at index <i>k</i>{@code +start-dstOffset} in the argument
	 * {@code s}, if <i>k</i> is greater than or equal to {@code dstOffset} but is
	 * less than {@code dstOffset+end-start}
	 * <li>the character at index <i>k</i>{@code -(end-start)} in this sequence, if
	 * <i>k</i> is greater than or equal to {@code dstOffset+end-start}
	 * </ul>
	 * <p>
	 * The {@code dstOffset} argument must be greater than or equal to {@code 0},
	 ...
	 *
	 * <p>
	 * If {@code s} is {@code null}, then this method inserts characters as if the s
	 * parameter was a sequence containing the four characters {@code "null"}.
	 *
	 ...
	 * @return a reference to this object.
	 * @throws IndexOutOfBoundsException if {@code dstOffset} is negative or greater
	 *                                   than {@code this.length()}, or
	...
	/**
	 * Inserts the string representation of the {@code boolean} argument into this
	 * sequence.
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 * string by the method {@link String#valueOf(boolean)}, and the characters of
	 * that string were then {@link #insert(int,String) inserted} into this
	 * character sequence at the indicated offset.
	 * <p>
	 * The {@code offset} argument must be greater than or equal to {@code 0}, and
	 ...
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 * string by the method {@link String#valueOf(char)}, and the character in that
	 * string were then {@link #insert(int,String) inserted} into this character
	 ...
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 * string by the method {@link String#valueOf(int)}, and the characters of that
	 * string were then {@link #insert(int,String) inserted} into this character
	 * sequence at the indicated offset.
	 * <p>
	 * The {@code offset} argument must be greater than or equal to {@code 0}, and
	 ...
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 * string by the method {@link String#valueOf(long)}, and the characters of that
	 * string were then {@link #insert(int,String) inserted} into this character
	 * sequence at the indicated offset.
	 * <p>
	 * The {@code offset} argument must be greater than or equal to {@code 0}, and
	...
	/**
	 * Inserts the string representation of the {@code double} argument into this
	 * sequence.
	 * <p>
	 * The overall effect is exactly as if the second argument were converted to a
	 ...
	 * substring. The integer returned is the smallest value <i>k</i> such that:
	 * 
	 * <pre>
	 * {@code
	 ...
	 *         returned; if it does not occur as a substring, {@code -1} is
	 *         returned.
	 */
	 ...
	 * smallest value {@code k} for which:
	 * 
	 * <pre>
	 * {@code
	 ...
	 * the index value {@code this.length()}. The returned index is the largest
	 ...
	 *         substring is returned. If it does not occur as a substring,
	 *         {@code -1} is returned.
	 */
	 ...
	 * substring. The integer returned is the largest value <i>k</i> such that:
	 * 
	 * <pre>
	 * {@code
	 *     k <= Math.min(fromIndex, this.length()) &&
	 ...
	 * length in {@code char} values) just prior to execution of the {@code reverse}
	 * method. Then the character at index <i>k</i> in the new character sequence is
	 * equal to the character at index <i>n-k-1</i> in the old character sequence.
	 *
	 * <p>
	 * Note that the reverse operation may result in producing surrogate pairs that
	 * were unpaired low-surrogates and high-surrogates before the operation. For
	 * example, reversing "\u005CuDC00\u005CuD800" produces "\u005CuD800\u005CuDC00"
	...
	/**
	 * Returns a string representing the data in this sequence. A new {@code String}
	 * object is allocated and initialized to contain the character sequence
	 * currently represented by this object. This {@code String} is then returned.
