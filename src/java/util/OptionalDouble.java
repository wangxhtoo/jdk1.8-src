 ...
 * value are provided, such as {@link #orElse(double) orElse()} (return a
 * default value if value not present) and
 * {@link #ifPresent(java.util.function.DoubleConsumer) ifPresent()} (execute a
...
public final class OptionalDouble {
	...
	/**
	 * Returns an empty {@code OptionalDouble} instance. No value is present for
	 * this OptionalDouble.
	 *
	 ...
	 *
	 * @param other a {@code DoubleSupplier} whose result is returned if no value is
	 *              present
