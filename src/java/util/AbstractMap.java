...
public abstract class AbstractMap<K, V> implements Map<K, V> {
	 ...
	 * {@inheritDoc}
	 *
	 * @implSpec This implementation iterates over <tt>entrySet()</tt> searching for
	 *           an entry with the specified value. If such an entry is found,
	 ...
	 *
	 * @implSpec This implementation iterates over <tt>entrySet()</tt> searching for
	 *           an entry with the specified key. If such an entry is found,
	 *           <tt>true</tt> is returned. If the iteration terminates without
	 *           finding such an entry, <tt>false</tt> is returned. Note that this
	 ...
	 *
	 * @implSpec This implementation iterates over <tt>entrySet()</tt> searching for
	 *           an entry with the specified key. If such an entry is found, the
	 ...
	 *
	 * @implSpec This implementation iterates over <tt>entrySet()</tt> searching for
	 *           an entry with the specified key. If such an entry is found, its
	 *           value is obtained with its <tt>getValue</tt> operation, the entry
	 *           is removed from the collection (and the backing map) with the
	 *           iterator's <tt>remove</tt> operation, and the saved value is
	 *           returned. If the iteration terminates without finding such an
	 *           entry, <tt>null</tt> is returned. Note that this implementation
	 *           requires linear time in the size of the map; many implementations
	 ...
	 *           <tt>size</tt> method delegates to this map's <tt>size</tt> method
	 *           and the <tt>contains</tt> method delegates to this map's
	 ...
	 *           {@link AbstractCollection}. The subclass's iterator method returns
	 *           a "wrapper object" over this map's <tt>entrySet()</tt> iterator.
	 ...
	 *           map; if so it returns <tt>true</tt>. Then, it checks if the
	 *           specified object is a map whose size is identical to the size of
	 *           this map; if not, it returns <tt>false</tt>. If so, it iterates
	 *           over this map's <tt>entrySet</tt> collection, and checks that the
	 *           specified map contains each mapping that this map contains. If the
	 *           specified map fails to contain such a mapping, <tt>false</tt> is
	...
	/**
	 * Returns a shallow copy of this <tt>AbstractMap</tt> instance: the keys and
