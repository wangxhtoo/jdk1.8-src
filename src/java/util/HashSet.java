...
public class HashSet<E> extends AbstractSet<E> implements Set<E>, Cloneable, java.io.Serializable {
	...
	/**
	 * Constructs a new, empty linked hash set. (This package private constructor is
	 * only used by LinkedHashSet.) The backing HashMap instance is a LinkedHashMap
	 * with the specified initial capacity and the specified load factor.
	 *
	 * @param initialCapacity the initial capacity of the hash map
	 * @param loadFactor      the load factor of the hash map
	 * @param dummy           ignored (distinguishes this constructor from other
	 ...
	 * serialize it).
	 *
	 * @serialData The capacity of the backing <tt>HashMap</tt> instance (int), and
	 *             its load factor (float) are emitted, followed by the size of the
	 *             set (the number of elements it contains) (int), followed by all
	 *             of its elements (each an Object) in no particular order.
	 */
