 ...
 *
 * <table border="0" cellpadding="1" cellspacing="0" summary="Regular expression
 * constructs, and what they match">
 *
 * <tr align="left">
 ...
 * characters"><tt>&#92;u</tt><i>hhhh</i></td>
 * <td headers="matches">The character with
 * hexadecimal&nbsp;value&nbsp;<tt>0x</tt><i>hhhh</i></td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct
 * characters"><tt>&#92;x</tt><i>{h...h}</i></td>
 * <td headers="matches">The character with
 * hexadecimal&nbsp;value&nbsp;<tt>0x</tt><i>h...h</i>
 * ({@link java.lang.Character#MIN_CODE_POINT Character.MIN_CODE_POINT}
 * &nbsp;&lt;=&nbsp;<tt>0x</tt><i>h...h</i>&nbsp;&lt;=&nbsp;
 * {@link java.lang.Character#MAX_CODE_POINT Character.MAX_CODE_POINT})</td>
 * </tr>
 * <tr>
 ...
 * <tt>[ \t\xA0&#92;u1680&#92;u180e&#92;u2000-&#92;u200a&#92;u202f&#92;u205f&#92;u3000]</tt></td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct predef"><tt>\H</tt></td>
 * <td headers="matches">A non-horizontal whitespace character:
 * <tt>[^\h]</tt></td>
 * </tr>
 * <tr>
 ...
 * <tr>
 * <td valign="top" headers="construct predef"><tt>\V</tt></td>
 * <td headers="matches">A non-vertical whitespace character:
 * <tt>[^\v]</tt></td>
 * </tr>
 * <tr>
 ...
 * </tr>
 * <tr align="left">
 * <th colspan="2" id="posix"><b>POSIX character classes (US-ASCII
 * only)</b></th>
 * </tr>
 *
 * <tr>
 ...
 * character:{@code [\p{Lower}\p{Upper}]}</td>
 * </tr>
 * <tr>
 ...
 * character:{@code [\p{Alpha}\p{Digit}]}</td>
 * </tr>
 * <tr>
 ...
 * <tr>
 * <td valign="top" headers="construct
 * greedy"><i>X</i><tt>{</tt><i>n</i><tt>}</tt></td>
 ...
 * <tr>
 * <td valign="top" headers="construct
 * greedy"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}</tt></td>
 ...
 * <tr>
 * <td valign="top" headers="construct
 * reluc"><i>X</i><tt>{</tt><i>n</i><tt>}?</tt></td>
 * <td headers="matches"><i>X</i>, exactly <i>n</i> times</td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct
 ...
 * <tr>
 * <td valign="top" headers="construct
 * reluc"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}?</tt></td>
 * <td headers="matches"><i>X</i>, at least <i>n</i> but not more than <i>m</i>
 * times</td>
 * </tr>
 *
 ...
 * <tr>
 * <td valign="top" headers="construct
 * poss"><i>X</i><tt>{</tt><i>n</i><tt>}+</tt></td>
 * <td headers="matches"><i>X</i>, exactly <i>n</i> times</td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct
 ...
 * <tr>
 * <td valign="top" headers="construct
 * poss"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}+</tt></td>
 * <td headers="matches"><i>X</i>, at least <i>n</i> but not more than <i>m</i>
 * times</td>
 * </tr>
 *
 ...
 * backref"><tt>\</tt><i>k</i>&lt;<i>name</i>&gt;</td>
 ...
 *
 * <tr>
 * <td valign="top" headers="construct special"><tt>(?&lt;<a href=
 * "#groupname">name</a>&gt;</tt><i>X</i><tt>)</tt></td>
 * <td headers="matches"><i>X</i>, as a named-capturing group</td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct
 * special"><tt>(?:</tt><i>X</i><tt>)</tt></td>
 * <td headers="matches"><i>X</i>, as a non-capturing group</td>
 * </tr>
 * <tr>
 * <td valign="top" headers="construct
 * special"><tt>(?idmsuxU-idmsuxU)&nbsp;</tt></td>
 ...
 * <tr>
 * <td valign="top" headers="construct
 * special"><tt>(?idmsux-idmsux:</tt><i>X</i><tt>)</tt>&nbsp;&nbsp;</td>
 ...
 * <tt>\p{</tt><i>prop</i><tt>}</tt> matches if the input has the property
 * <i>prop</i>, while <tt>\P{</tt><i>prop</i><tt>}</tt> does not match if the
 ...
 * <td><tt>\w</tt></td>
 * <td>A word character:
 * <tt>[\p{Alpha}\p{gc=Mn}\p{gc=Me}\p{gc=Mc}\p{Digit}\p{gc=Pc}\p{IsJoin_Control}]</tt></td>
 * </tr>
 * <tr>
 * <td><tt>\W</tt></td>
 ...
 * <i>n</i><sup>th</sup><a href="#cg">capturing group</a> and
 * <tt>\g{</tt><i>name</i><tt>}</tt> for <a href="#groupname">named-capturing
 * group</a>.
 * </p>
 * </li>
 *
...
public final class Pattern implements java.io.Serializable {
	...
	private CharProperty bitsOrSingle(BitClass bits, int ch) {
		 ...
		 */
		int d;
		if (ch < 256 && !(has(CASE_INSENSITIVE) && has(UNICODE_CASE) && (ch == 0xff || ch == 0xb5 || ch == 0x49 || ch == 0x69 || // I and i
...
///////////////////////////////////////////////////////////////////////////////
	...
	private static class CharPropertyNames {
		...
		static {
			...
			defCategory("L", ((1 << Character.UPPERCASE_LETTER) | (1 << Character.LOWERCASE_LETTER) | (1 << Character.TITLECASE_LETTER) | (1 << Character.MODIFIER_LETTER)
			...
			defCategory("P", ((1 << Character.DASH_PUNCTUATION) | (1 << Character.START_PUNCTUATION) | (1 << Character.END_PUNCTUATION) | (1 << Character.CONNECTOR_PUNCTUATION)
					| (1 << Character.OTHER_PUNCTUATION) | (1 << Character.INITIAL_QUOTE_PUNCTUATION) | (1 << Character.FINAL_QUOTE_PUNCTUATION)));
			...
			defCategory("LD", ((1 << Character.UPPERCASE_LETTER) | (1 << Character.LOWERCASE_LETTER) | (1 << Character.TITLECASE_LETTER) | (1 << Character.MODIFIER_LETTER)
