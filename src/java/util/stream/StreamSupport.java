...
public final class StreamSupport {
	 ...
	 * {@link #stream(java.util.function.Supplier, int, boolean)} should be used to
	 * reduce the scope of potential interference with the source. See
	 * <a href="package-summary.html#NonInterference">Non-Interference</a> for more
	 * details.
	 *
	...
	/**
	 * Creates a new sequential or parallel {@code Stream} from a {@code Supplier}
	 * of {@code Spliterator}.
	 *
	 * <p>
	 ...
	 * <a href="../Spliterator.html#binding">late-binding</a>, it is likely more
	 * efficient to use {@link #stream(java.util.Spliterator, boolean)} instead.
	 * <p>
	 * The use of a {@code Supplier} in this form provides a level of indirection
	 * that reduces the scope of potential interference with the source. Since the
	 * supplier is only invoked after the terminal operation commences, any
	 * modifications to the source up to the start of the terminal operation are
	 * reflected in the stream result. See
	 * <a href="package-summary.html#NonInterference">Non-Interference</a> for more
	 * details.
	 *
	 * @param <T>             the type of stream elements
	 ...
	 *                        {@code Spliterator}. The characteristics must be equal
	 *                        to {@code supplier.get().characteristics()}, otherwise
	 *                        undefined behavior may occur when terminal operation
	 *                        commences.
	 * @param parallel        if {@code true} then the returned stream is a parallel
	 *                        stream; if {@code false} the returned stream is a
	 *                        sequential stream.
	 ...
	 * {@code IMMUTABLE} or {@code CONCURRENT}, or be
	 * <a href="../Spliterator.html#binding">late-binding</a>. Otherwise,
	 * {@link #intStream(java.util.function.Supplier, int, boolean)} should be used
	 ...
	 * {@code CONCURRENT}, or that are
	 * <a href="../Spliterator.html#binding">late-binding</a>, it is likely more
	 * efficient to use {@link #intStream(java.util.Spliterator.OfInt, boolean)}
	 * instead.
	 * <p>
	 * The use of a {@code Supplier} in this form provides a level of indirection
	 * that reduces the scope of potential interference with the source. Since the
	 ...
	 * @param characteristics Spliterator characteristics of the supplied
	 *                        {@code Spliterator.OfInt}. The characteristics must be
	 ...
	 * {@code IMMUTABLE} or {@code CONCURRENT}, or be
	 * <a href="../Spliterator.html#binding">late-binding</a>. Otherwise,
	 * {@link #longStream(java.util.function.Supplier, int, boolean)} should be used
	 * to reduce the scope of potential interference with the source. See
	 * <a href="package-summary.html#NonInterference">Non-Interference</a> for more
	 * details.
	 *
	 ...
	 * {@code CONCURRENT}, or that are
	 * <a href="../Spliterator.html#binding">late-binding</a>, it is likely more
	 * efficient to use {@link #longStream(java.util.Spliterator.OfLong, boolean)}
	 * instead.
	 * <p>
	 * The use of a {@code Supplier} in this form provides a level of indirection
	 * that reduces the scope of potential interference with the source. Since the
	 ...
	 * @param characteristics Spliterator characteristics of the supplied
	 *                        {@code Spliterator.OfLong}. The characteristics must
	 *                        be equal to {@code supplier.get().characteristics()},
	 *                        otherwise undefined behavior may occur when terminal
	 *                        operation commences.
	 * @param parallel        if {@code true} then the returned stream is a parallel
	 *                        stream; if {@code false} the returned stream is a
	 ...
	 * {@code IMMUTABLE} or {@code CONCURRENT}, or be
	 * <a href="../Spliterator.html#binding">late-binding</a>. Otherwise,
	 * {@link #doubleStream(java.util.function.Supplier, int, boolean)} should be
	 * used to reduce the scope of potential interference with the source. See
	 * <a href="package-summary.html#NonInterference">Non-Interference</a> for more
	 * details.
	 *
	 * @param spliterator A {@code Spliterator.OfDouble} describing the stream
	 *                    elements
	 * @param parallel    if {@code true} then the returned stream is a parallel
	 *                    stream; if {@code false} the returned stream is a
	 *                    sequential stream.
	 ...
	 * <a href="../Spliterator.html#binding">late-binding</a>, it is likely more
	 * efficient to use
	 * {@link #doubleStream(java.util.Spliterator.OfDouble, boolean)} instead.
	 * <p>
	 * The use of a {@code Supplier} in this form provides a level of indirection
	 * that reduces the scope of potential interference with the source. Since the
	 * supplier is only invoked after the terminal operation commences, any
	 ...
	 * @param characteristics Spliterator characteristics of the supplied
	 *                        {@code Spliterator.OfDouble}. The characteristics must
	 *                        be equal to {@code supplier.get().characteristics()},
	 *                        otherwise undefined behavior may occur when terminal
	 *                        operation commences.
	 * @param parallel        if {@code true} then the returned stream is a parallel
