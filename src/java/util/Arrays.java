...
public class Arrays {
	 ...
	 * @throws NullPointerException           if the specified array or function is
	 *                                        null
	 * @since 1.8
	 */
	 ...
	 *         guarantees that the return value will be &gt;= 0 if and only if the
	 *         key is found.
	 * @throws ClassCastException             if the search key is not comparable to
	 *                                        the elements of the array within the
	 *                                        specified range.
	 * @throws IllegalArgumentException       if {@code fromIndex > toIndex}
	 * @throws ArrayIndexOutOfBoundsException if
	 *                                        {@code fromIndex < 0 or toIndex > a.length}
	 ...
	 * @param a   the array to be searched
	 * @param key the value to be searched for
	 * @param c   the comparator by which the array is ordered. A <tt>null</tt>
	 *            value indicates that the elements' {@linkplain Comparable natural
	 *            ordering} should be used.
	 * @return index of the search key, if it is contained in the array; otherwise,
	 *         <tt>(-(<i>insertion point</i>) - 1)</tt>. The <i>insertion point</i>
	 ...
	 *                            comparator, or the search key is not comparable to
	 *                            the elements of the array using this comparator.
	 */
	 ...
	 *         guarantees that the return value will be &gt;= 0 if and only if the
	 *         key is found.
	 * @throws ClassCastException             if the range contains elements that
	 *                                        are not <i>mutually comparable</i>
	 *                                        using the specified comparator, or the
	 *                                        search key is not comparable to the
	 *                                        elements in the range using this
	 *                                        comparator.
	 * @throws IllegalArgumentException       if {@code fromIndex > toIndex}
	 * @throws ArrayIndexOutOfBoundsException if
	 *                                        {@code fromIndex < 0 or toIndex > a.length}
	 ...
	 *
	 * @param a         the array to be filled
	 * @param fromIndex the index of the first element (inclusive) to be filled with
	 *                  the specified value
	 ...
	 * @param a   the array to be filled
	 * @param val the value to be stored in all elements of the array
	 * @throws ArrayStoreException if the specified value is not of a runtime type
	 ...
	 *                                        runtime type that can be stored in the
	 *                                        specified array
	 */
	 ...
	 * @throws NullPointerException           if <tt>original</tt> is null
	 * @throws ArrayStoreException            if an element copied from
	 *                                        <tt>original</tt> is not of a runtime
	 *                                        type that can be stored in an array of
	 *                                        class <tt>newType</tt>.
	 * @since 1.6
	 */
