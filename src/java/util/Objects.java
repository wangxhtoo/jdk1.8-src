 ...
 * objects. These utilities include {@code null}-safe or {@code
 * null}-tolerant methods for computing the hash code of an object, returning a
...
public final class Objects {
	 ...
	 * {@code true} is returned and if exactly one argument is {@code null}, {@code
	...
	/**
	 * Returns the result of calling {@code toString} on the first argument if the
	 * first argument is not {@code null} and returns the second argument otherwise.
	 *
	 * @param o           an object
	 * @param nullDefault string to return if the first argument is {@code null}
	 * @return the result of calling {@code toString} on the first argument if it is
	 *         not {@code null} and the second argument otherwise.
	 ...
	 * c.compare(a, b)} otherwise. Consequently, if both arguments are {@code null}
	 * 0 is returned.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Unlike the method {@link #requireNonNull(Object, String)}, this method allows
	 * creation of the message to be deferred until after the null check is made.
	 * While this may confer a performance advantage in the non-null case, when
	 * deciding to call this method care should be taken that the costs of creating
	 * the message supplier are less than the cost of just creating the string
	 * message directly.
	 *
	 * @param obj             the object reference to check for nullity
	 * @param messageSupplier supplier of the detail message to be used in the event
	 *                        that a {@code NullPointerException} is thrown
	 * @param                 <T> the type of the reference
	 * @return {@code obj} if not {@code null}
	 * @throws NullPointerException if {@code obj} is {@code null}
	 * @since 1.8
