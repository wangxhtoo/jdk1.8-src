 ...
 *
 * @param <T> the type of the first argument to the function	第一个输入参数类型
 * @param <U> the type of the second argument to the function	第二个输入参数类型
 * @param <R> the type of the result of the function	返回值类型
 *
 * @see Function
 * @since 1.8
 */
