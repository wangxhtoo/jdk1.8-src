...
public abstract class AccessibleBundle {
	...
	/**
	 * The locale independent name of the state. This is a programmatic name that is
	...
	/**
	 * Obtains the key as a localized string. If a localized string cannot be found
	 * for the key, the locale independent key stored in the role will be returned.
	 * This method is intended to be used only by subclasses so that they can
	 * specify their own resource bundles which contain localized strings for their
	 * keys.
	 * 
	 * @param resourceBundleName the name of the resource bundle to use for lookup
